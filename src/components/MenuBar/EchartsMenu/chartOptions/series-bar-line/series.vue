  ...
  <div class="series">
    ...
    <div v-show="item.type === 'bar'">
      ...
      <el-form-item label="圆角">
        <el-input-number v-model="item.itemStyle.borderRadius" :step="1"></el-input-number>
      </el-form-item>
    </div>
    <div v-show="item.type === 'line'">
