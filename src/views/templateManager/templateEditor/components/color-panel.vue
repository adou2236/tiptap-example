...
<style lang="scss" scoped>
  ...
  .box{
    ...
    margin-top: 2px; padding: 10px; padding-bottom: 5px;
  ...
  .hd{
    ...
    .colorView{ width: 100%; height: 30px; float: left; transition: background-color .3s ease; }
    .defaultColor{ width: 80px; float: right; text-align: center; border: 1px solid #ddd; cursor: pointer; color: #333; }
  }
  .tColor{
    li{ width: 15px; height: 15px; display: inline-block; margin: 0 2px; transition: all .3s ease;border: 1px solid #D8D8D8; }
  ...
  .bColor{
    ...
    li{
      ...
      li{ display: block; width: 15px; height: 15px; transition: all .3s ease; margin: 0;border: 1px solid #D8D8D8; }
      li:hover{ box-shadow: 0 0 5px rgba(0,0,0,.4); transform: scale(1.3); }
    }
  }
</style>
