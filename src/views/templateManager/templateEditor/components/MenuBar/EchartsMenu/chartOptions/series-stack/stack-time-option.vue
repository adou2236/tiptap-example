<template>
    <el-form @submit.native.prevent size="mini" class="gray-box" label-position="left">
      ...
      <el-form-item label="图例名称">
        <el-checkbox :disabled="regionType!=='currentArea'" v-model="showLegend">显示图例</el-checkbox>
        <el-input :disabled="regionType!=='currentArea'||!showLegend" placeholder="输入图例名称" v-model="rename"></el-input>
      </el-form-item>
